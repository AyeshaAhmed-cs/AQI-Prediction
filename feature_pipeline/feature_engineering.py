...
if __name__ == "__main__":
    ...
    if features.empty:
        ...
        print("🚀 Sending data to Hopsworks...")
        # FORCE ONLINE ONLY: This avoids triggering the materialization job entirely
        fg.insert(features, storage_connector=None, write_options={"start_offline_materialization": False, "wait_for_job": False}) 
        print("✅ Success: Data package delivered to Online Store.")
