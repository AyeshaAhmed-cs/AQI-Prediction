...
def get_live_weather():
    try:
        ...
        return {
            ...
            'wind': 35.0,  # <--- FORCE THIS TO 35 (Stress Test)
            'hum': 30.0,   # <--- FORCE THIS TO 30 (Dry air helps)
            ...
            'is_day': is_actually_day,
            'forecast': res['hourly']
        }
    except:
        return {'temp': 25, 'wind': 35, 'hum': 30, 'pres': 1013, # Force here too
